...
Tener más ccartas altas en la baraja es una ventaja para el
jugador. Se le asigna un valor a cada carta de acuerdo a la
siguiente tabla.
...
La función debe tomar un parámetro carta que puede ser un número
o una cadena de caracteres y luego aumentar
o reducir el valor de la variable global conteo
de acuerdo al valor de la carta (observa la tabla).

La función debe retornar una cadena de caracteres con el conteo
actual y la cadena:

- 'Apostar' si el conteo es positivo.
- 'Esperar' si el conteo es negativo.

El conteo actual y la decisión del jugador ('Apostar' o 'Esperar')
